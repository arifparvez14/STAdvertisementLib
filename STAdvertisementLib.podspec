...
Pod::Spec.new do |spec|
 ...
 This CocoaPods library helps you perform meaningful calculation like addition and others.
  ...
  # Or just: spec.author    = "Muhammad Ariful Islam"
  # spec.authors            = { "Muhammad Ariful Islam" => "arif.mbstu22@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/Muhammad Ariful Islam"
  ...
  spec.source_files  = "STAdvertisementLib/**/*.{h,m}"
